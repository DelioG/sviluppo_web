<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST")
    {
        ...
        $_SESSION['produttore']    = $_POST['produttore'];
        $_SESSION['nome']          = $_POST['nome'];
        $_SESSION['lotto']         = $_POST['lotto'];
        $_SESSION['quantita']      = $_POST['quantita'];
        $_SESSION['data_scadenza'] = $_POST['data_scadenza'];
                        ...
                        <div class="container-create-new">
                            ...
                            <div class="create-new">
                                ...
                                <form method="POST" action="">
                                    ...
                                    <input type="text" name="produttore" placeholder="Inserisci il nome del produttore del prodotto..." maxlength="30"  value="<?php echo isset($_SESSION['produttore']) ? htmlspecialchars($_SESSION['produttore']) : ''; unset($_SESSION['produttore']); ?>" required>

                                    <label>Nome Prodotto: </label>
                                    <input type="text" name="nome" placeholder="Inserisci il nome del prodotto..." maxlength="30" value="<?php echo isset($_SESSION['nome']) ? htmlspecialchars($_SESSION['nome']) : ''; unset($_SESSION['nome']); ?>" required>
                                    
                                    <label>Lotto Prodotto: </label>
                                    <input type="text" name="lotto" placeholder="Inserisci il lotto del prodotto..." maxlength="30" value="<?php echo isset($_SESSION['lotto']) ? htmlspecialchars($_SESSION['lotto']) : ''; unset($_SESSION['lotto']); ?>" required>

                                    <label>Quantità (in pezzi): </label>
                                    <input type="number" name="quantita" placeholder="Inserisci la quantità del prodotto disponibile..." min="0" value="<?php echo isset($_SESSION['quantita']) ? htmlspecialchars($_SESSION['quantita']) : ''; unset($_SESSION['quantita']); ?>" required>

                                    <label>Data Scadenza: </label>
                                    <input type="date" name="data_scadenza" value="<?php echo isset($_SESSION['data_scadenza']) ? htmlspecialchars($_SESSION['data_scadenza']) : ''; unset($_SESSION['data_scadenza']); ?>" required>
                            ...
                            <table class="recap-table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td data-label="Produttore">      <?= htmlspecialchars_decode ($prodotto -> getProduttore(), ENT_QUOTES);                   ?> </td>
                                        <td data-label="Nome Produttore"> <?= htmlspecialchars_decode ($prodotto -> getNome(), ENT_QUOTES);                         ?> </td>
