<?php
    ...
    class Controller
    {
        ...
        public function insertNewProdotto ($produttore, $nome, $lotto, $quantita, $data_scadenza)
        {
            ...
            {
                $status_msg = ['status' => false, 'message' => "Il nome del produttore può contenere solo caratteri alfabetici (a-z), caratteri numerici (0-9), il punto (.) e l'apostrofo ('), con un massimo di 30 caratteri"];
            }
            else if (!preg_match("/^[a-zA-ZÀ-ÖØ-öø-ÿ' ]{1,30}$/", $nome)) 
            {
