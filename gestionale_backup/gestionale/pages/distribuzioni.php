<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST")
    {
        ...
        $result_msg = $controller -> insertNewDistribuzione($_POST["data_distribuzione"]);
                ...
                <div class="col-dx" id="mainContent">
                    <div class="col-dx-container" id="colDxContainer">
                        ...
                        <div class="container-create-new">
                                <div class="tutorial">
                                    <p> <i title="Breve Introduzione" class="bi bi-info-circle"></i> Informazioni sulle Distribuzioni</p>
                                    <p>
                                        Per facilitare il tracciamento dei prodotti distribuiti alle famiglie, ricorda di assegnare i prodotti alla distribuzione dopo averla effettuata. 
                                        <br><br>
                                        Inoltre, assegna sempre le famiglie servite a quella specifica distribuzione.
                                    </p>
                                </div>
                                <div class="create-new">
                                    <p class="create-new-heading">Effettua Distribuzione</p>
                                    <form method="POST" action="">

                                        <label>Data Distribuzione: </label>
                                        <input type="date" name="data_distribuzione" required>
